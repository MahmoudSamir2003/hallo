...
for(let i=0;i<proudcts.length;i++){
            bootStr.innerHTML+=
            `<div class="card col-md-6 col-sm-12 " style="width: 18rem;">
           ...
           <div class="basket-1">
             <div class="basket">
             <a href="checkout.html"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart-fill" viewBox="0 0 16 16">
